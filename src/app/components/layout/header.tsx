			...
			<div className="me-auto pc-mob-drp">
				<ul className="list-unstyled">
					...
					<li className="dropdown pc-h-item d-inline-flex d-md-none">
						<a className="pc-head-link head-link-secondary dropdown-toggle arrow-none m-0"
					...
					<li className="pc-h-item d-none d-md-inline-flex">
						<form className="header-search">
							...
							<button className="btn btn-light-secondary btn-search"><i
								className="ti ti-adjustments-horizontal"></i></button>
						</form>
					</li>
				</ul>
			</div>

			<div className={'w-25 rounded-3 d-flex align-items-center justify-content-between'}>
				<span className={"fw-bold px-4"}>En route</span>
				<span> 10 min </span>
			</div>
		</div>
	</header>
